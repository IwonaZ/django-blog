...
from blog.views import PostListView, UserPostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, about
...
class TestViews(TestCase):
    def setUp(self):
        ...
        self.post1 = Blog.objects.create(title="SOME TITLE", body="SOME TEXT", date=datetime.datetime(2021, 12, 7, 20, 8, 7, 127325, tzinfo=pytz.UTC), author=self.user)
